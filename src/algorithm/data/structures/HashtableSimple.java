 ...
 */
public class HashtableSimple implements Algorithm {
    private String[] table = new String[DEFAULT_SIZE];
    private LinkedList<String>[] table2 = new LinkedList[DEFAULT_SIZE];
    private int size = 0;
    private static int DEFAULT_SIZE = 5;
    private static final String TAG = "HashtableSimple: ";
